...
fun mapHistoryEntityToDataModel(entity: HistoryEntity): DataModel {
    val searchResult = DataModel(entity.word, listOf(Meanings(Translation(translation = entity.translation),imageUrl = entity.imageUrl)))
    return searchResult
}
